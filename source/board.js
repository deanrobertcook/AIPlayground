...
Board.prototype = {
	...
	setCellValue: function(xPos, yPos, value) {
	...
	getCellValue: function(xPos, yPos) {
		if (this.isCellLegal(xPos, yPos)) {
	...
	addAgentToCell: function(agent, xPos, yPos) {
	...
	removeAgentFromCell: function(agent, xPos, yPos) {
		if (this.isCellLegal(xPos, yPos)) {
	...
	cellContainsAgent: function(agent, xPos, yPos) {
		if (this.isCellLegal(xPos, yPos)) {
			var cell = this.board[xPos][yPos];
	...
	getAgentsFromCell: function(xPos, yPos) {;
		if (this.isCellLegal(xPos, yPos)) {
			var cell = this.board[xPos][yPos];
			var agents = [];
			for (var i = 0; i < cell.length; i++) {
	...
	isCellLegal: function(xPos, yPos) {	
	...
	isCellClear: function(xPos, yPos) {	
	...
	moveAgent: function(agent, moveVector) {
